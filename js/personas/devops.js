  ...
  sections: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          en: { role: 'DevOps Engineer', description: 'Created and maintained ARO clusters synchronized with ArgoCD, automated the deployment of microservices, migrated pipelines from Tekton to Jenkins, and followed good GitOps practices.<br><br>Worked extensively with Kubernetes clusters, Docker images, documentation, and meetings with clients and stakeholders.' },
          es: { role: 'Ingeniero DevOps', description: 'Creé y mantuve clústeres ARO sincronizados con ArgoCD, automaticé el despliegue de microservicios, migré pipelines de Tekton a Jenkins y seguí buenas prácticas de GitOps.<br><br>Trabajé extensivamente con clústeres Kubernetes, imágenes Docker, documentación y reuniones con clientes.' },
        },
      ],
    },
    {
